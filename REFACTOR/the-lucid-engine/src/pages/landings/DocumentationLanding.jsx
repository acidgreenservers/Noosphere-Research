                ...
                <div className="max-w-5xl mx-auto">
                    <div className="md-card p-10 glow-card mb-8">
                        ...
                        <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto italic">
                            "Access the full archives of the Consciousness Revolution"
                        </p>
                        <div className="flex flex-wrap gap-4 justify-center">
                            ...
                            <a href="#whitepapers" className="md-button-secondary">
            ...
            <section id="synthesis" className="py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {/* Chronicle */}
                        <a href="reading-material/the-consciousness-revolution-chronicle.md" className="md-card p-6 glow-card hover:bg-white/5 transition block group">
                            <h3 className="text-xl font-bold text-purple-400 mb-2 group-hover:text-purple-300">📖 The Consciousness Revolution Chronicle</h3>
                            <p className="text-gray-300">Complete chronological synthesis from Big Bang to current day - how everything connects through consciousness field theory.</p>
                        </a>
                        {/* Solving Reality */}
                        <Link to="/pages/papers/qctoe-theory.html" className="md-card p-6 glow-card hover:bg-white/5 transition block group">
                            <h3 className="text-xl font-bold text-purple-400 mb-2 group-hover:text-purple-300">🌟 Solving Reality</h3>
                            <p className="text-gray-300">The Quantized Context Theory of Everything (QCTOE).</p>
                        </Link>
                        {/* QSA */}
                        <a href="qsa-writedown/qualitative-semantic-analysis.md" className="md-card p-6 glow-card hover:bg-white/5 transition block group">
                            <h3 className="text-xl font-bold text-green-400 mb-2 group-hover:text-green-300">📊 Qualitative Semantic Analysis</h3>
                            <p className="text-gray-300">Semantic analysis of consciousness revolution repository themes and patterns.</p>
                        </a>
                        {/* Human Coherence */}
                        <Link to="/pages/papers/human-coherence-attenuation-practice.html" className="md-card p-6 glow-card hover:bg-white/5 transition block group">
                            <h3 className="text-xl font-bold text-green-400 mb-2 group-hover:text-green-300">🧘 Human Coherence</h3>
                            <p className="text-gray-300">Practical implementations for everyday life.</p>
                        </Link>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="md-card p-6 glow-card">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><Link to="/pages/papers/informational-reality-framework.html" className="text-link">🔬 Informational Reality Framework</Link></li>
                                <li><Link to="/pages/papers/solving-reality.html" className="text-link">🌟 Solving Reality</Link></li>
